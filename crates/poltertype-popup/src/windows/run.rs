//! The popup thread's own loop: owns the window and the renderer,
//! parks on a 16 ms tick, and turns posted mouse messages into hover
//! and accept events.
//!
...
pub(super) fn run(cmd_rx: Receiver<Cmd>, events: Sender<PopupUiEvent>) {
